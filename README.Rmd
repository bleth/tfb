...
TFB includes 4 sample datasets for the user. They have been created via data generating process (DGP), the specifics of which are available at https://github.com/bleth/tfb/blob/main/data-raw/tfb_sampledat1.R. Looking at the first dataset:
