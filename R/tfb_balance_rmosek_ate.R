#' Targeted Function Balancing Optimization with RMOSEK -- ATE
#'
#' This function solves the linear optimization problem presented by TFB with MOSEK, given information from an initial regression, with the ATE as the estimand.
...
tfb_balance_rmosek_ate <- function(
    X_c,
    X_t,
    beta_c,
    beta_t,
